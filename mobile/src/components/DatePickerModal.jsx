...
const s = StyleSheet.create({
  ...
  moisAnnee: { fontSize: 18, fontFamily: fonts.outfit.bold, color: colors.text },
  grille: { flexDirection: 'row', flexWrap: 'wrap' },
  jourLabel: { width: '14.28%', textAlign: 'center', fontSize: 11, fontFamily: fonts.jakarta.semiBold, color: colors.textSecondary, paddingVertical: spacing.xs },
