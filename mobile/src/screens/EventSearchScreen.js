...
const makeStyles = (colors) => StyleSheet.create({
  ...
  filterBadgeText: { fontSize: 9, fontFamily: fonts.jakarta.bold, color: colors.white },
  ...
  modalTitre: { fontSize: 18, fontFamily: fonts.outfit.semiBold, color: colors.text },
  modalReset: { fontSize: 13, fontFamily: fonts.jakarta.medium, color: colors.accent },
  filterLabel: { fontSize: 13, fontFamily: fonts.jakarta.semiBold, color: colors.textSecondary, marginBottom: 8, marginTop: 4 },
  chipsWrap: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
  ...
  modalValiderText: { fontSize: 15, fontFamily: fonts.jakarta.semiBold, color: colors.white },
})
