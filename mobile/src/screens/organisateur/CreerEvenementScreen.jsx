...
const s = StyleSheet.create({
  ...
  stepperCircleActive: { backgroundColor: 'rgba(212,165,116,0.4)', borderColor: '#D4A574' },
  ...
  stepperLabelActive: { fontFamily: fonts.jakarta.semiBold, color: '#D4A574' },
  ...
  calDaySelected: { backgroundColor: 'rgba(212,165,116,0.4)' },
  ...
  promoToggleTrackActive: { backgroundColor: 'rgba(212,165,116,0.6)' },
  ...
  promoTypeBtnActive: { backgroundColor: 'rgba(212,165,116,0.4)', borderColor: '#D4A574' },
