...
const ICONES_BILLETS = { Standard: '🎟️', VIP: '⭐', Premium: '💫', 'Carré Or': '💎', Fosse: '🕺', Autre: '🎫' }
...
const makeStyles = (colors) => StyleSheet.create({
  ...
  stepperCircle: {
    ...
    backgroundColor: 'rgba(0,0,0,0.06)', borderWidth: 2, borderColor: 'rgba(0,0,0,0.12)',
  },
  stepperCircleDone: { backgroundColor: 'rgba(34,197,94,0.4)', borderColor: '#22C55E' },
  stepperCircleActive: { backgroundColor: colors.accent + '66', borderColor: colors.accent },
  ...
  stepperLabelDone: { color: colors.accent },
  stepperLine: { width: 20, height: 2, backgroundColor: 'rgba(0,0,0,0.08)', marginHorizontal: 6 },
  stepperLineDone: { backgroundColor: colors.accent },
  ...
  calWeekDay: { flex: 1, textAlign: 'center', fontFamily: fonts.outfit.semiBold, fontSize: 13, color: 'rgba(0,0,0,0.35)', paddingVertical: 4 },
  calGrid: { flexDirection: 'row', flexWrap: 'wrap' },
  calDay: { width: '14.28%', aspectRatio: 1, justifyContent: 'center', alignItems: 'center', borderRadius: 8 },
  calDaySelected: { backgroundColor: colors.accent + '66' },
  ...
  timeBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(0,0,0,0.06)', justifyContent: 'center', alignItems: 'center' },
  ...
  promoToggleTrack: {
    width: 44, height: 24, borderRadius: 12, backgroundColor: 'rgba(0,0,0,0.08)',
    justifyContent: 'center', paddingHorizontal: 2, marginRight: 10,
  },
  promoToggleTrackActive: { backgroundColor: colors.accent + '99' },
  ...
  promoTypeBtn: {
    ...
    backgroundColor: 'rgba(0,0,0,0.04)', borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(0,0,0,0.08)',
  },
  promoTypeBtnActive: { backgroundColor: colors.accent + '66', borderColor: colors.accent },
  ...
  warningTitle: { fontFamily: fonts.outfit.semiBold, fontSize: 14, color: colors.warning, marginBottom: 4 },
