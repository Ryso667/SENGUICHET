...
const strengthConfig = [
  ...
  { label: "Moyen", color: "var(--warning)", segments: 2 },
  { label: "Fort", color: "var(--success)", segments: 3 },
  { label: "Très fort", color: "var(--success)", segments: 4 },
];
        ...
        <div className="w-full max-w-[440px]" style={{ animation: "fadeInUp 0.4s ease-out" }}>
          ...
          <div className="glass-card p-8 sm:p-10">
            ...
            <p className="text-center mt-6 text-sm" style={{ color: "rgba(255,255,255,0.5)", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
              Déjà un compte ?{" "}
              <Link to="/connexion" className="font-medium hover:underline" style={{ color: "var(--primary)" }}>Se connecter</Link>
            </p>
          </div>
        </div>
      </div>
